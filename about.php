...
<div class="content">
		...
		<div class="container">
			...
			<div class="card">
				...
				<button type="button" class="btn btn-info"><a href="https://www.w3.org/TR/html5/">Learn More</a></button>
			</div>
			<div class="card">
				...
				<button type="button" class="btn btn-info"><a href="https://www.w3.org/TR/CSS/">Learn More</a></button>
			</div>
			<div class="card">
				...
				<button type="button" class="btn btn-info"><a href="http://www.w3schools.com/js/default.asp">Learn More</a></button>
			</div>
			<div class="card">
				...
				<button type="button" class="btn btn-info"><a href="http://php.net">Learn More</a></button>
			</div>
			...
			<div class="card">
				...
				<button type="button" class="btn btn-info"><a href="https://laravel.com">Learn More</a></button>
			</div>
			<div class="card">
				...
				<button type="button" class="btn btn-info"><a href="http://jquery.com">Learn More</a></button>
			</div>
			<div class="card">
				...
				<button type="button" class="btn btn-info"><a href="http://getbootstrap.com">Learn More</a></button>
			</div>
			<h4>Tools</h4>
			<div class="card">
				...
				<button type="button" class="btn btn-info"><a href="https://git-scm.com">Learn More</a></button>
			</div>
			<div class="card">
				<img src="resources/images/github.png" alt="">
				...
				<button type="button" class="btn btn-info"><a href="">Learn More</a></button>
			</div>
			<div class="card">
				<img src="resources/images/iterm.png" alt="">
			...
			<div class="card">
				<img src="resources/images/filezilla.png" alt="">
				<h4 class="tech-name">FileZilla</h4>
				<p class="tech-info">FileZilla is an FTP software. I used this to upload my files to the server. FileZilla can be used with MAC or Windows and supports a wide range of connections such as FTP and SFTP like we are using in class.</p>
				<button type="button" class="btn btn-info"><a href="">Learn More</a></button>
			</div>
			<div class="card">
				<img src="resources/images/mamp.png" alt="">
			...
			<div class="card">
				<img src="resources/images/ps.png" alt="">
			...
			<h4>Database</h4>
			<div class="card">
				<img src="resources/images/mysql.png" alt="">
			...
			<div class="card">
				<img src="resources/images/sequelpro.png" alt="">
			...
			<h4>Text Editor</h4>
			<div class="card">
				<img src="resources/images/sublime.png" alt="">
