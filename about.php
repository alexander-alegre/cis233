...
<div class="content">
		...
		<div class="container">
			...
			<div class="card">
				...
				<a href="https://www.w3.org/TR/html5/" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
			<div class="card">
				...
				<a href="https://www.w3.org/TR/CSS/" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
			<div class="card">
				...
				<a href="http://www.w3schools.com/js/default.asp" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
			<div class="card">
				...
				<a href="http://php.net" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
			...
			<div class="card">
				...
				<a href="http://jquery.com" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
			<div class="card">
				...
				<a href="http://getbootstrap.com" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
			<h4>Tools</h4>
			<div class="card">
				...
				<a href="https://git-scm.com" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
			<div class="card">
				...
				<a href="https://github.com/alexander-alegre/cis233" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
			<div class="card">
				...
				<a href="https://www.iterm2.com/" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
			<div class="card">
				<img src="resources/images/cyberduck.png" alt="cyberduck logo">
				...
				<a href="https://cyberduck.io/?l=en" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
			<div class="card">
				...
				<a href="https://www.mamp.info/en/" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
			<div class="card">
				...
				<a href="https://www.adobe.com/products/photoshop.html?sdid=KKQIN&mv=search&s_kwcid=AL!3085!3!155836184321!e!!g!!photoshop&ef_id=WCD@KgAAAEpkYkeO:20170127090612:s" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
			<h4>Database</h4>
			<div class="card">
				...
				<a href="https://www.mysql.com/" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
			<div class="card">
				...
				<a href="https://www.sequelpro.com/" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
			<h4>Text Editor</h4>
			<div class="card">
				...
				<a href="https://www.sublimetext.com/" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
			...
			<div class="card">
				...
				<a href="http://www.apple.com/mac/" target="_blank"><button type="button" class="btn btn-info">Learn More</button></a>
			</div>
		</div>
	</div>
